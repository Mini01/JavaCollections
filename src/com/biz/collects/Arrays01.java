...
public class Arrays01 {
	...
	public static void main(String[] args) {
		...
		// 사용할떄는 먼저 Arrays01을 별도로 개체로 생성(복제하여)
		// 그 객체로 부터 new 키워드를 호출 사용해야 inner class를
		// 사용할 수 있다.
	...
	// inner class 첫 시작 키워드를 일반적으로 private로 선언을 한다.
	...
	public void bb() {
		System.out.println("나는 BB mehtod");
	}
